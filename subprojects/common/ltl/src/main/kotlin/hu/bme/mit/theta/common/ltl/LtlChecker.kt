...
class LtlChecker<RState : ExprState, RBlank : ExprState, RAction : StmtAction, RPrec : Prec, RBlankPrec : Prec, DataPrec : Prec, DataState : ExprState> (
    ...
    private val defineNextSide: (MultiState<RBlank, CfaState<UnitState>, DataState>) -> MultiSide = LtlCheck::alternatingNextSide,
...
)  : SafetyChecker<ARG<RState, RAction>, Trace<RState, RAction>, RPrec> {
    override fun check(prec: RPrec): SafetyResult<ARG<RState, RAction>, Trace<RState, RAction>> {
