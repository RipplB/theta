...
public final class MultiBuilder {
	...
	public record Result<LState extends State, RState extends State, DataState extends State, LBlank extends State, RBlank extends State,
			...
			(MultiAnalysis<LState, RState, DataState, LBlank, RBlank, LAction, RAction, LPrec, RPrec, DataPrec, LBlankPrec, RBlankPrec, MState, MAction> analysis, MultiLts<LState, RState, DataState, LBlank, RBlank, LAction, RAction, MState, MAction> lts){}
