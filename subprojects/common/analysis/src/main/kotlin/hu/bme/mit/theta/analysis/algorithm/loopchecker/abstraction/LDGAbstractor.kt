...
class LDGAbstractor<S : ExprState, A : ExprAction, P : Prec>(
    private val analysis: Analysis<S, in A, in P>, private val lts: LTS<S, A>,
    private val acceptancePredicate: AcceptancePredicate<S, A>,
    private val searchStrategy: LoopcheckerSearchStrategy, private val logger: Logger
) : Abstractor<P, LDG<S, A>> {

    override fun createWitness() = LDG(acceptancePredicate)
