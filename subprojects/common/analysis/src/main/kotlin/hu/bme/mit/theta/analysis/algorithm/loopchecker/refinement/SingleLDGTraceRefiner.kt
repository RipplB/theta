...
class SingleLDGTraceRefiner<S : ExprState, A : ExprAction, P : Prec>(
    private val strategy: LDGTraceCheckerStrategy, private val solverFactory: SolverFactory,
    private val refiner: JoiningPrecRefiner<S, A, P, ItpRefutation>,
    private val logger: Logger, private val init: Expr<BoolType> = True()
) : LDGTraceRefiner<S, A, P> {

    override fun refine(witness: LDG<S, A>, prec: P): RefinerResult<S, A, P, LDGTrace<S, A>> {
